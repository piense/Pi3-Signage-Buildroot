...
<div class="col-sm-3">
	<form>
	  <div class="form-group">
		<label><h5>Airplay Config</h5></label><br>
		<label>Enabled:</label>
		<label>Conference Display:</label>
		<input class="form-control" id="conference" placeholder="Hello, log on to wifi to connect." value=""><br>
	  </div>
	</form>
